...
class StudentEvent with _$StudentEvent {
  ...
  const factory StudentEvent.addStudent({required Student student}) = AddStudent;
  const factory StudentEvent.sortData({required int start,required int end}) = SortData;
